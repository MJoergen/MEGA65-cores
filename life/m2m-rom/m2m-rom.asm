...
#include "shell_fh_ptrs.asm"
#include "shell_fhandles.asm"
#include "globals.asm"
...
CUSTOM_MSG      XOR     R8, R8                  ; no custom message
                RET
